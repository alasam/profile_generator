...
rl.question("What's your name? Nicknames are also acceptable :)! ", (name) => {
  ...
  rl.question("What's an activity you like doing?", (activity) => {
      ...
      rl.question("What kidn of music do you listen to? ", (music) => {
        ...
        rl.question("What favorite meal of the day? ", (meal) => {
          ...
          rl.question("What's your favorite kind of food? ", (food) => {
            ...
            rl.question("What's your favorite sport? ", (sport) => {
              ...
              console.log(`Hi there! This is ${name}. They love ${activity} during the day, while listening to some ${music}. ${name} also loves ${meal}, especial if it's ${food}! Sometimes ${name} likes to watch or play ${sport} and imagine they had ${supPower}.`)
